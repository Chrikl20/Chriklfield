...
Prüfungen: 43 lokale Tests, Typprüfung, Linting, Worker-Bundle und Produktionsbuild am 7. September bestanden. Am 8. September bestanden der gezielte Build mit Testadapter und der echte Vercel-Preview-Build (`READY`). Die anschliessende Prüfung der Vercel-Seite wurde nach einem Hänger abgebrochen. GitHub Actions prüfte danach die lokale Demo auf Desktop und im mobilen Layout erfolgreich. Nach Korrektur des CommonJS-Testeinstiegs bestand der gesamte [CI-Lauf auf `31e35b15`](https://github.com/Chrikl20/Chriklfield/actions/runs/34266257916): Typprüfung/Lint/Tests/Build, native PostgreSQL-Nebenläufigkeit und Desktop-/Mobil-E2E. Details und Grenzen: `docs/verification.md`. Keine Live-Modellgenerierung, reale Zahlung oder Produktionspromotion durchgeführt.
