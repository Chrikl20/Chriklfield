...
export async function migrations() {
  return (
    await Promise.all(
      [
        '202609050001_core.sql',
        '202609050002_storage_templates.sql',
        '202609060001_recovery.sql',
        '202609070001_direct_uploads.sql',
      ].map((f) => readFile(`supabase/migrations/${f}`, 'utf8')),
    )
  ).join('\n');
}
